...
export async function createServiceRequest(
  ...
  const sr: ServiceRequest = {
    ...
    state:         dto.approvalRequired ? ServiceRequestState.PENDING_APPROVAL : ServiceRequestState.SUBMITTED,
    ...
    approvalState:    dto.approvalRequired ? ApprovalState.REQUESTED : ApprovalState.NOT_REQUIRED,
    approvers:     [],
    attachments:   [],
    sla,
    createdAt: now,
