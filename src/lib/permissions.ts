...
export const ROLE_META: Record<UserRole, { label: string; description: string; color: string; bg: string }> = {
  system_admin: { label: "Sistem Yöneticisi", description: "Tüm organizasyonlara tam platform erişimi", color: "text-rose-700",    bg: "bg-rose-100"    },
  ...
  viewer:       { label: "Görüntüleyici",      description: "Sadece ana sayfa görüntüleme",              color: "text-gray-600",    bg: "bg-gray-100"    },
